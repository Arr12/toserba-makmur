...
--
-- Host: localhost
-- Waktu pembuatan: 11. Februari 2022 jam 18:15
-- Versi Server: 5.1.41
-- Versi PHP: 5.3.1
...
CREATE TABLE IF NOT EXISTS `detail_penjualan` (
  ...
  KEY `kode_penjualan` (`id_penjualan`),
  KEY `kode_barang` (`kode_barang`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `laporan_pembelian` (
